...
def scrape_cars_tool(car_names: str, user_decision: Optional[str] = None, use_custom_search: bool = True) -> str:
    ...
    def _process_single_car(car: str) -> tuple[str, dict]:
        ...
        if is_code_car(car):
            ...
            # Web search for remaining specs
            car_data = scrape_car_data(car, manual_specs, use_custom_search=use_custom_search, pdf_specs=None)
    ...
    from vehicle_development_agent.extraction.generation_comparison import extract_old_generation_data
