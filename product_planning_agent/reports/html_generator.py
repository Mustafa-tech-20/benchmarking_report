...
"""
            ...
            for variant_key, variant_data in variants.items():
                ...
                features = ensure_list(variant_data.get('features'))
                features_added = ensure_list(variant_data.get('features_added'))
                features_deleted = ensure_list(variant_data.get('features_deleted'))
...
"""
                    ...
                    prev_variant = variant_keys_list[variant_keys_list.index(variant_key) - 1]
                    prev_vdata = variants[prev_variant]
                    prev_name = prev_vdata.get('name', prev_variant) if isinstance(prev_vdata, dict) else prev_variant
                    html += f"""
        ...
        <div class="header-actions">
            <nav class="main-nav">
                ...
                <div class="nav-dropdown">
                    ...
                    <div class="nav-dropdown-menu" id="variants-dropdown">
                ...
                <div class="nav-dropdown">
                    ...
                    <div class="nav-dropdown-menu" id="lifecycle-dropdown">
                        <!-- Populated dynamically with car names -->
                    </div>
                </div>
                <div class="nav-dropdown">
