...
from product_planning_agent.core.resource_scheduler import ResourceType
...
class ScraperMetrics:
    ...
    def get_resource_utilization(self) -> Dict[str, float]:
        ...
        from product_planning_agent.async_config import rate_limit_config
